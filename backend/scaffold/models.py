...
class GrantTemplate(Base):
    ...
    # When the tax loans generated from this template are due (YYYY-MM-DD). The
    # wizard generates tax loans whenever the user enters $0 cost basis, and falls
    # back to inheriting the purchase-loan due date for that year if this is null.
