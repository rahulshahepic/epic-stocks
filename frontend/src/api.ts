...
export const api = {
  ...
  getCompEntries: () => apiFetch<{ entries: Record<string, { salary?: number | null; bonus?: number | null }> }>('/api/retirement/comp-entries'),
  saveCompEntries: (entries: Record<string, { salary?: number | null; bonus?: number | null }>) => put<{ entries: Record<string, { salary?: number | null; bonus?: number | null }> }>('/api/retirement/comp-entries', { entries }),
  ...
  getSharedCompEntries: (invId: number) => apiFetch<{ entries: Record<string, { salary?: number | null; bonus?: number | null }> }>(`/api/sharing/view/${invId}/comp-entries`),
